...
def main():
	filepath = "/tmp/Carsharing_Output/out_analysis.txt"
	...
	pp.pprint(features_column.keys())
	print("#Features:", len(features_column))
	pp.pprint(algoColumn)
	pp.pprint(tColumn)
	pp.pprint(acsColumn)
	pp.pprint(zColumn)
	...
	acses = [2,4,6]
	for algorithm in ["max-time"]: #["max_time", "max_parking", "rnd"]:
		data[algorithm]={}
